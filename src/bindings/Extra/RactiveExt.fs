...
module FunScript.Bindings.Ractive.RactiveExt
...
type RactiveEventStream(ractive: Ractive, eventName: string) =
   interface IObservable<RactiveEvent*obj> with
      member x.Subscribe observer =
            ...
            new FunScript.Core.Events.ActionDisposable(fun () -> remover.cancel()) :> System.IDisposable
