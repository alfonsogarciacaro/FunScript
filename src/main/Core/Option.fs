...
type Option private() =
   member __.IsSome with [<JSEmitInline("({0}!==null)")>] get() = failwith "never"
   member __.IsNone with [<JSEmitInline("({0}===null)")>] get() = failwith "never"
   member __.Value with [<JSEmitInline("{0}")>] get() = failwith "never"
